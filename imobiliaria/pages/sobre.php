<div class="about-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 offset-md-1"><img alt="" src="assets/images/sobre-image.webp" class="img-fluid"></div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-11  offset-md-1">
                <div class="info">
                    <h2 class="title title-2">Missão</h2>
                    <p class="text text-1">Oferecer soluções em serviços imobiliários com qualidade, agilidade e segurança aos nossos clientes.</p>
                </div>
                <div class="info">
                    <h2 class="title title-2">Visão</h2>
                    <p class="text text-1">Ser a principal referência em serviços imobiliários de Santa Catarina em 2024.</p>
                </div>
                <div class="info">
                    <h2 class="title title-2">Valores</h2>
                    <p class="text text-1">• Honestidade; <br>• Profissionalismo; <br>• Simplicidade; <br>• Encantamento; <br>• Aperfeiçoamento Contínuo.</p>
                </div>
                <div class="info">
